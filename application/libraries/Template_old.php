...
class Template {
    ...
    public function validation($v){
        $validation = '';
        $validation .='<select class="uk-form-select" name="validation_rules" id="validation_rules_'.$v->name.'">
        ...
        foreach($v->radio_label as $key=>$value){
                   $radio.=  '<div class="uk-grid option">
                                <div class="uk-width-medium-1-3">
                                    <div class="uk-form-controls">
                                        <input type="text" value="'.$value.'" class="select_option select_option_label uk-width-1-1" placeholder="RadioOption Label" data-optionid="'.$v->choices[$key]->id.'" />
                                    </div>
                                </div>
                        <div class="uk-width-medium-1-3">
                            <div class="uk-form-controls">
    ...
    public function time_option($v){
        ...
        $validation = '';
        $validation .='<select class="uk-form-select" name="time_format" id="time_format_'.$v->name.'">
                            <option value="12"'.(($v->format == 12)?" selected":"").'>12 Hrs</option>
                            <option value="24" '.(($v->format == 24)?" selected":"").'>24 Hrs</option>
                       </select>';
        return $validation;
    }
