...
<body class="error_page">
    ...
    <div class="error_page_content">
        <div class="uk-width-8-10 uk-container-center">
            <p class="heading_b">Oops! Seems like some unexpected error has occurred.</p>
            <p class="uk-text-large">
                The requested URL <span class="uk-text-muted"></span> have some restrictions.
            </p>
