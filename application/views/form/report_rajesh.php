	    ...
	    <div class="md-card">
	    	<div class="md-card-content large-padding">
		    	<form method="post" action ="<?php echo base_url() ?>form/reports" id="filter_form">
		    		...
		    		<div class="uk-width-1-2 advanced_filters">
			    		...
			    		<div class="uk-grid advanced_filter" data-filter ="0">
			    			<div class="uk-width-3-10" >
			    				<select id="filter" name="filter[filter][0][column]" onchange = "filter_change(this)">
			    					<option value=""> </option>
					...
					<div class="uk-width-1-2"><a class="advanced_check_filters">Advanced</a>
					<div class="check_filters" style="display:none">
						<div class="uk-grid">
		    				...
		    				<!-- <input type="checkbox" value="Submitted By" name="columns[]" />  -->
			<!-- 				<div class="uk-width-1-3">
						 ...
						 <?php foreach($required as $key=>$value){
								if($value[1] === '1'){ ?>
								<div class="uk-width-1-3">
									<input type="checkbox" name="columns[]" value="<?php echo $value[0]; ?>"  /> <?php echo $value[0]; ?>
								</div>
								<?php } ?>
						<?php } ?> 
		                    ...
		                    <tbody>
                        		...
                        		<tr>
                            		<td class="uk-width-1-10 uk-text-center">
                            			<a href="<?php echo base_url() ?>form/review/<?php echo $key; ?>">
                            				<?php echo $key; ?>
                            			</a>
                            		</td>
