<div id="templates">
        ...
        <div id="config_heading" style="display : none">
            ...
            <div class="portlet-content portlet-content-heading" type="heading" style="display:none" data-fieldid ="17">
                <div class="tab">
                    <ul class="uk-tab">
                    ...
                    <div id="tabs-1" style="margin-left:10px;margin-bottom: 10px">
                        ...
                        <div class="uk-form uk-form-stacked">
                            <div class="uk-form-row">
                                <label for="heading_label" class="uk-form-labels">Title<span style="color:red">*</span></label>
                                <div class="uk-form-controls">
                                    <input type="text" class="heading_label" id="heading_label" placeholder="Enter your heading title" value="" /><br/>
            ...
            <div class="portlet-content portlet-content-text" type="text" style="display:none" data-fieldid ="1">
                <div class="tab">
                    ...
                    <div id="tabs-1" style="margin-left:10px;margin-bottom: 10px">
                        ...
                        <div class="uk-form uk-form-stacked">
                            <div class="uk-form-row">
                                <label for="text_label" class="uk-form-labels">Label <span style="color:red">*</span></label>
                                <div class="uk-form-controls">
                                    <input type="text" class="text_label" id="text_label" placeholder="Enter your text label" value="" /><br/>
                                    <span>(Can't be empty .min : 4 char, max 20 chars)</span>
                                </div>
                            </div>
                            <div class="uk-form-row">
        ...
        <div id="config_radio" style="display : none">
            <div class="portlet-header">
                ...
                <div class="title_radio">
                    <input type="radio" /> <span class="title_value">first</span>
                    <input type="radio" /> <span class="title_value">second</span>
                </div>
                 </div>
                 <div class="uk-width-1-2">
                <i class="uk-icon-remove delete_field"></i>                     
               ...
               <div class="uk-grid">
                 <div class="uk-width-1-2">
                    <div class="title_checkbox">
                        <input type="checkbox" /> <span class="title_value">first</span>
                        <input type="checkbox" /> <span class="title_value">second</span>
                    </div>
                </div>
                <div class="uk-width-1-2">
                <i class="uk-icon-remove delete_field"></i>                     
