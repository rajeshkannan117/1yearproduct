    ...
    <div id="page_content_inner">
        <div class="uk-grid">
            <div class="uk-width-1-2">
                <a class="md-btn md-btn-primary" style="float:left" href="<?php echo base_url() ?>todo">
                    Back to TODO
                </a> 
        ...
        <div class="md-card">
            ...
            <div class="uk-grid" data-uk-grid-margin>
                ...
                <form action ="<?php echo base_url() ?>todo/review_submission" method="post" id="formreview" name = "review">
                    <?php
                        $row = 0;
