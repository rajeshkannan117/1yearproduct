...
<tr style="background:#fff">    
<td style="text-align:center;color: #565656;font-family: Georgia,serif;font-size: 20px;line-height: 35px;padding-top:40px">Your Form Submitted Successfully</td> 
</tr>
<tr style="background:#fff">
<td style="text-align:center;color: #565656;font-family: Georgia,serif;font-size: 20px;line-height: 35px;padding:20px 0px 40px">Please <span style="padding:10px; background:#6699ff;border-radius:10px;color:#fff">Wait for reviewers</span> can submit the form</td>
</tr>
