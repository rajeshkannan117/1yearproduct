...
<td style="text-align:center;color: #565656;font-family: Georgia,serif;font-size: 25px;line-height: 35px;padding-top:40px"><span><b style="color:red">ALERT!!</b></span></td> 
</tr>
<tr style="background:#fff">    
<td style="text-align:center;color: #565656;font-family: Georgia,serif;font-size: 20px;line-height: 35px;padding:20px 0px 40px">User K398P has submitted the form</td> 
</tr>
