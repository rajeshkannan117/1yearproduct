...
<tr style="background:#fff">
<td style="text-align:center;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 35px;padding:20px 0px 40px">
<p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">To activate this password click the link below 
</p>
...
<!-- Your New Password : <span><b><?php echo $password; ?></b></span> -->
</td>
</tr>
