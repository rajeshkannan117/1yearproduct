...
<head>
    ...
    <link rel="icon" type="<?php echo base_url(); ?>assets/image/png" href="<?php echo base_url(); ?>assets/assets/images/favicon-01.png" sizes="16x16">
    ...
    <aside id="sidebar_main">
        ...
        <div class="menu_section">
            ...
            <?php if($org_id != 1) { 
                ...
                <li <?php if($page == 'alert'){ echo ' class="current_section"'; $alert ="alerts"; } else{$alert = 'alert'; }?> title="<?php echo $this->lang->line('alerts'); ?>">
