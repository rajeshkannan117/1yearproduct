...
class Form_model extends CI_Model
{
    ...
    */
    ...
    public function form_details($form_id){
    	...
    	$this->db->select('f.form_id,f.form_name,f.form_code,f.form_desc,f.form_content,f.status,f.default,f.form_type,f.assign_to,f.response_to')
    			->from('form_details f')
    ...
    public function form_submission_list($form_id){
        ...
        $this->db->select('f.id,f.form_id,f.created_at')
