...
class Form_model extends CI_Model
{
    ...
    /* Form Work Flow */
    public function form_hierarchy_insert($form_id){
        $res = $this->form_details($form_id);
        $this->db->insert('form_hierarchy',array('form_hierarchy_name' => $res->form_name.' Work Flow','form_id'=>$form_id));
	...
	public function form_list(){
    	...
    	$this->db->select('f.form_id,f.form_name,f.form_desc,f.status,f.created_by,f.default,f.due_date')
    			  ->from('form_details f');
    ...
    public function form_submission_data($submission_id){
        $query = 'Select uf.user_form_info_text_id,uf.submission_id,uf.form_field_id,CONCAT_WS(" ",u.firstname,u.lastname) as submitted_by,uf.answer,fs.created_at,ff.question
    ...
    */
    ...
    public function form_details($form_id){
    	...
    	$this->db->select('f.form_id,f.form_name,f.form_code,f.form_desc,f.form_content,f.status,f.default,f.created_by,f.form_type,f.assign_to,f.response_to,f.org_id')
