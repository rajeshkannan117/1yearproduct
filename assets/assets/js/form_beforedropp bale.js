			...
			over :function(event,ui){
				...
				if(colcount === 1){
                    ...
                    if(over_id != undefined){
                  	...
                  	$('#'+rowid).find('.ui-droppable').css('width',width);
                
                   var parentli_id = $('ul#'+rowid,'li.ui-droppable').last().attr('id');

                   console.log(parentli_id);
                   if(parentli_id != undefined){
                  	if($("ul#"+rowid).find('li').size() == 0){
                  				
							 $('#'+rowid+' li#'+parentli_id).after('<li class="highlight" style="width:'+width+'"></li>');
                    	}
                  }
              }
