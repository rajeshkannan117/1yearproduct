...
(function(window, document, undefined){
    ...
    $('body').on( 'init.dt', '.dt-uikit', function () {
            ...
            if(!$(this).hasClass('md-processed')) {
                ...
                altair_md.inputs();
                var  = dt_filter.clone(),$('.dataTables_wrapper').find('.uk-width-medium-2-3').prepend(div),var add = $(document).find('.uk-text-right').html(),var target_class = $('.dataTables_filter').parent().attr('class'),$('.'+target_class).append(add),$('.uk-width-medium-1-3').find('.dataTables_filter').remove(),$(document).find('.uk-text-right').remove(),$('.dataTables_wrapper').find('.uk-width-medium-1-3').remove(),$('.dataTables_wrapper').find('.uk-width-medium-2-3').removeClass('uk-width-medium-2-3').addClass('uk-width-medium-1-1'),
