    ...
    $("td.config").droppable({
      ...
      drop: function( event, ui ) {
        ...
        if(!$(this).find('.cols').length){
            ...
            radius = new RegExp("(radius)","g");
            html = html.replace(radius,'radius_'+comptField);
            console.log(type);
    ...
    $(document).on('click','span.addRadio', function(e){
       ...
       // console.log($(html).find("[data-optionid]").removeData('optionid'));
        ...
        $(document).on('click','span.deleteOption',function(){ 
            ...
            _type = $(this).parent().parent().parent().parent().parent().parent().parent().parent().attr('type');
           if(_type !== 'checkbox'){
               console.log(_type);
...
$('#text_label').keyup(function(){
    ...
    function generateObjects(type,thisobj,i){
            ...
            fielddata.name = $('.'+type+'_name', thisobj).val();
             if(type === 'submit'){
       ...
       tabFieldName = new Array;
        ...
        if(type !== undefined){
              ...
              if (str.search(regexp) == -1){
                  textName.after('<p class="error">Can\'t be empty & can\'t contain spaces or special character.Underscore allowed</p>');
                  errorDiv = error = 1;
              ...
              if(surveyValue.search(reg_exp_survey) == -1){
                  surveyName.after('<p class="error">Test</p>');
                   errorDiv = error = 1;
                   _grandParent.addClass('field_error');
              }
              ...
              var reg_exp_label = /^[a-zA-Z0-9-_ ]{3,20}$/;
              ...
              var reg_exp_reset_submit = /^[a-zA-Z-_ ]{3,20}$/;
